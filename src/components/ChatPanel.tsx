    ...
    <div className="w-80 bg-black border-l border-white/10 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        ...
        <div className="flex items-center gap-1.5 justify-center py-2">
          ...
          <span className="text-white/15 text-[10px] tracking-widest uppercase">Messages are destroyed when room closes</span>
        </div>

        {chatMessages.length === 0 && (
          <p className="text-white/20 text-xs text-center mt-6 tracking-wide uppercase">
            No messages yet
          </p>
        )}
